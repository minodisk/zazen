...
(function(exports) {
  var FailTask, Klass, The, createActor, createId, createTask, defer, getArgumentNames, isArray, isFunction, slice, toString, _ref;
  ...
  The = (function(_super) {
    ...
    The.prototype._then = function(argsList) {
      ...
      this.index = index;
      if (The.verbose) {
        console.log("" + (this.toStateString()) + "#_then()");
      }
      task = this.tasks[this.index];
    ...
    MultiTask = (function(_super) {
      ...
      function MultiTask(actors, context, fail) {
        ...
        for (i = _i = 0, _len = actors.length; _i < _len; i = ++_i) {
          actor = actors[i];
          this.actors[i] = createActor(actor, context, fail);
        }
      }
